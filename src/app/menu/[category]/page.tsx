...
const CategoryPage = () => {
  return (
    <div>  
      <div>
      <h1 className="text-uppercase text-red-900 xl:text-6xl xl:mx-35 mx-8 font-bold my-10 text-[3rem] md:text-5xl">Cakes</h1>
      <div className="w-screen overflow-x-scroll bg-zinc-50 text-black-500">
       ...
       <div className="w-max flex">
         ...
         {featuredProducts.map((item) => (
           <div
             key={item.id}
             className="w-[60vw] h-[50vh] m-6 rounded-lg flex flex-col items-center justify-around p-4 bg-yellow-600 transition-all duration-300 md:w-[50vw] xl:w-[23vw] xl:h-[60vh] overflow-hidden"
           >
             {/* IMAGE CONTAINER */}
             {item.img && (
